...
export function Navbar() {
  return (
    <header className="pt-5 fixed  bottom-0 left-0 right-0 max-w-screen-lg mx-auto bg-gray-950">
      <div className=" flex justify-between h-16 mx-auto bg-gray-900 rounded-2xl">
        <a
